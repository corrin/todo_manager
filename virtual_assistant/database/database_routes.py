...
def remove_external_account():
    ...
    try:
        ...
        was_primary = ext_account.is_primary_calendar if account_type == "calendar" else ext_account.is_primary_tasks

        ExternalAccount.delete_by_email_and_provider(ext_account.external_email, ext_account.provider, current_user.id)
