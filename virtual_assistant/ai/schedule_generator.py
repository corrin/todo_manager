...
class ScheduleGenerator:
    ...
    def generate_daily_schedule(self, user_id, custom_instructions=None, date=None, slot_duration=60):
        ...
        try:
            ...
            # Parse the response
            logger.debug("[DEBUG] Parsing AI response")
    ...
    def _create_schedule_prompt(self, tasks, custom_instructions, target_date, slot_duration=60):
        ...
        if custom_instructions:
            logger.debug("[DEBUG] Adding custom instructions to prompt")
            prompt += f"""
        ...
        logger.debug("[DEBUG] Adding standard scheduling instructions")
        prompt += """
